...
function processMessage(decodedOscMessage) {
    ...
    // DATA
    if (commandType === "DATA") {
        if (commandID === BackEndCommand.BootMeasurementData || commandID === BackEndCommand.StepRecalMeasurementData || commandID === BackEndCommand.StepRecalRecordCalibration ) { //---TODO
