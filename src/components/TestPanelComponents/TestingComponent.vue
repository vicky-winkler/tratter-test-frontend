...
import s1fImage from "../../assets/imgs/sensor_viz/fail/s1_fail.png"
import s2fImage from "../../assets/imgs/sensor_viz/fail/s2_fail.png"
import s3fImage from "../../assets/imgs/sensor_viz/fail/s3_fail.png"
import s4fImage from "../../assets/imgs/sensor_viz/fail/s4_fail.png"
import s5fImage from "../../assets/imgs/sensor_viz/fail/s5_fail.png"
import s6fImage from "../../assets/imgs/sensor_viz/fail/s6_fail.png"
import s7fImage from "../../assets/imgs/sensor_viz/fail/s7_fail.png"
import s1sImage from "../../assets/imgs/sensor_viz/ok/s1_success.png"
import s2sImage from "../../assets/imgs/sensor_viz/ok/s2_success.png"
import s3sImage from "../../assets/imgs/sensor_viz/ok/s3_success.png"
import s4sImage from "../../assets/imgs/sensor_viz/ok/s4_success.png"
import s5sImage from "../../assets/imgs/sensor_viz/ok/s5_success.png"
import s6sImage from "../../assets/imgs/sensor_viz/ok/s6_success.png"
import s7sImage from "../../assets/imgs/sensor_viz/ok/s7_success.png"
...
function processMessage(decodedOscMessage) {
  ...
  if (commandType === "DATA") {
      // FINAL RESULT
    if (commandID === BackEndCommand.FinalResults) 
    {
